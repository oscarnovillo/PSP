...
public class ServletSession extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer global = (Integer)getServletContext().getAttribute("contador");
        if (global==null)
        {
            getServletContext().setAttribute("contador", 1);
        }
        else
        {
            getServletContext().setAttribute("contador", global+1);
        }
        
        Integer i = (Integer)sesion.getAttribute("numero");
        ...
        {
            sesion.setAttribute("numero", i+1);
        }
